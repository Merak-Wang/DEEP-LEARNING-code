...
#将train_data的所有行和第二列到在倒数第二列和test_data的所有行和第二列到最后一列拼接起来
...
def k_fold(k, X_train, y_train, num_epochs, learning_rate, weight_decay, batch_size):
    ...
    for i in range(k):
        ...
        net = get_net()
        train_ls, valid_ls = train(net, X_train , y_train , X_valid , y_valid, num_epochs, learning_rate=learning_rate,weight_decay=weight_decay, batch_size=batch_size)
...
k, num_epochs, lr, weight_decay, batch_size = 5, 100, 25, 1e-4, 64
